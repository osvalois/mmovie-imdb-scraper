...
func getTop10MoviesHandler(w http.ResponseWriter, r *http.Request) {
	URLMovies250 := "https://www.imdb.com/search/title/?groups=top_1000&view=simple&sort=user_rating,desc&count=250&start=0"
...
// Función auxiliar para extraer el número de estrellas de una cadena en formato SVG
func extractStarsFromSVG(svg string) string {
	// Imprimir el contenido del SVG para depuración
	log.Println("//--///--///--")
	log.Println("svg")
	log.Println(svg)
